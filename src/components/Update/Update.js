...
const Update = () => {
  const [book] = useBook();
  const { _id, image, name, description, price, quantity, supplier, sold } =
    book;
        ...
        buttons: [
          {
            ...
            onClick: () => {
              const updatedQuantity =
                parseInt(quantity) + parseInt(restockAmount);
        ...
        <div className="d-flex flex-column flex-md-row gap-4 align-items-center">
          ...
          <div>
            ...
            <button
              ...
              className="border-0 w-100 mb-4 text-white py-2 px-4 rounded-3 fw-bold f-merriweather primary-bg delivered-button"
            >
              Delivered
            </button>
            ...
            <Form onSubmit={handleRestockButton}>
              ...
              <button
                className="border-0 text-white w-100 py-2 px-4 rounded-3 fw-bold f-merriweather secondary-bg button"
                type="submit"
              >
                Restock
              </button>
