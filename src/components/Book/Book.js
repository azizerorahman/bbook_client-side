    ...
    <Col>
      <Card className="h-100 p-4 book">
        ...
        <Card.Body className="p-0">
          <Card.Title className="fs-4 fw-bold mt-4 mb-0 f-merriweather">
            {name}
          </Card.Title>
          <p className="my-1">
            <span className="lightergray-color">Supplier</span> • {supplier}
          </p>
        ...
        <Card.Footer className="p-0 bg-transparent border-0">
          <div className="d-flex justify-content-between fs-3 f-rasa">
            <p className="m-0 lightergray-color">
              Price: <span className="primary-color">${price}</span>
            </p>
            <p className="m-0 lightergray-color">
              Quantity: <span className="primary-color">{quantity}</span>
            </p>
          </div>
          <Link to={`/inventory/${_id}`}>
            <Button className="border-0 py-2 px-4 mt-3 rounded-3 fw-bold f-merriweather secondary-bg button">
              Update
            </Button>
          </Link>
        </Card.Footer>
